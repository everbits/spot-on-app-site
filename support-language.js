(function () {
    var translations = {
        en: {
            pageTitle: "SpotOn Support",
            pageDescription: "Support contact details and help information for the SpotOn app.",
            themeButton: "Switch theme",
            eyebrowHero: "SpotOn support",
            heroTitle: "Need help with SpotOn?",
            ...
            contactBody: "The best way to reach the SpotOn team for account, billing, and app issues.",
            ...
            operatedByBody: "SpotOn support is provided by Everbit AB.",
        ...
        sv: {
            pageTitle: "SpotOn Support",
            pageDescription: "Kontaktuppgifter och supportinformation för SpotOn-appen.",
            themeButton: "Byt tema",
            eyebrowHero: "SpotOn support",
            heroTitle: "Behöver du hjälp med SpotOn?",
            ...
            contactBody: "Det bästa sättet att nå SpotOn-teamet för konto-, betalnings- och appfrågor.",
            ...
            operatedByBody: "SpotOn-supporten tillhandahålls av Everbit AB.",
